...
/// </summary>
public class ZeroOrMoreMacro : IMacroSymbol
{
    /// <summary>
    ...
    public ZeroOrMoreMacro(params ISymbol[] symbols)
    {
        var sentence = new Sentence(symbols);

        Type = SymbolType.Macro;
        Name = "Zero or More Macro";
        MacroType = MacroType.ZeroOrMore;
        Symbols = sentence;
    }
    ...
    {
        return other is ZeroOrMoreMacro macro
    ...
    {
        yield return Symbols.Add(nonTerminal);
